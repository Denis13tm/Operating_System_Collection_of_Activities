...
# Execute main function and log to a file
main > server_health_check.log 2>&1

echo "Server health check completed. Results are saved in server_health_check.log."
